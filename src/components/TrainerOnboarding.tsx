...
/**
 * Trainer onboarding — Phase 1 scope: a single real screen that saves a
 * genuine TrainerProfile via /api/onboarding/trainer. The full multi-step
 * cinematic version (matching the athlete flow's step machine) is later
 * phase work; this is functional, not a mockup.
 */
